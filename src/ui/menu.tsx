...
export const Arrow = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.ArrowProps>>(Menu.Arrow, 'arrow');
...
export const CheckboxItem = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.CheckboxItemProps>>(
  Menu.CheckboxItem,
  'item',
);

export const Content = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.ContentProps>>(Menu.Content, 'content');

export const ContextTrigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, Menu.ContextTriggerProps>>(
  Menu.ContextTrigger,
  'contextTrigger',
);
...
export const ItemGroupLabel = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.ItemGroupLabelProps>>(
  Menu.ItemGroupLabel,
  'itemGroupLabel',
);
...
export const ItemIndicator = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.ItemIndicatorProps>>(
  Menu.ItemIndicator,
  'itemIndicator',
);

export const Item = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.ItemProps>>(Menu.Item, 'item');
...
export const RadioItemGroup = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.RadioItemGroupProps>>(
  Menu.RadioItemGroup,
  'itemGroup',
);
...
export const TriggerItem = withContext<HTMLDivElement, Assign<JsxStyleProps, Menu.TriggerItemProps>>(
  Menu.TriggerItem,
  'triggerItem',
);
