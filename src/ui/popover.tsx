...
export const Anchor = withContext<HTMLDivElement, Assign<JsxStyleProps, Popover.AnchorProps>>(Popover.Anchor, 'anchor');

export const Arrow = withContext<HTMLDivElement, Assign<JsxStyleProps, Popover.ArrowProps>>(Popover.Arrow, 'arrow');
...
export const CloseTrigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, Popover.CloseTriggerProps>>(
...
export const Description = withContext<HTMLParagraphElement, Assign<JsxStyleProps, Popover.DescriptionProps>>(
  Popover.Description,
  'description',
);
...
export const Positioner = withContext<HTMLDivElement, Assign<JsxStyleProps, Popover.PositionerProps>>(
  Popover.Positioner,
  'positioner',
);

export const Title = withContext<HTMLDivElement, Assign<JsxStyleProps, Popover.TitleProps>>(Popover.Title, 'title');
