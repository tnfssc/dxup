...
export const Arrow = withContext<HTMLDivElement, Assign<JsxStyleProps, HoverCard.ArrowProps>>(HoverCard.Arrow, 'arrow');
...
export const Positioner = withContext<HTMLDivElement, Assign<JsxStyleProps, HoverCard.PositionerProps>>(
  HoverCard.Positioner,
  'positioner',
);

export const Trigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, HoverCard.TriggerProps>>(
  HoverCard.Trigger,
  'trigger',
);

export { HoverCardContext as Context, type HoverCardContextProps as ContextProps } from '@ark-ui/react/hover-card';
