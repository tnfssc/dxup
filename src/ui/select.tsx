...
export interface RootProps extends Assign<JsxStyleProps, Select.RootProps<Select.CollectionItem>>, SelectVariantProps {}
export const Root = withProvider<HTMLDivElement, RootProps>(Select.Root, 'root');

export const ClearTrigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, Select.ClearTriggerProps>>(
  Select.ClearTrigger,
  'clearTrigger',
);
...
export const ItemGroupLabel = withContext<HTMLDivElement, Assign<JsxStyleProps, Select.ItemGroupLabelProps>>(
...
export const ItemIndicator = withContext<HTMLDivElement, Assign<JsxStyleProps, Select.ItemIndicatorProps>>(
  Select.ItemIndicator,
  'itemIndicator',
);

export const Item = withContext<HTMLDivElement, Assign<JsxStyleProps, Select.ItemProps>>(Select.Item, 'item');
...
export const Label = withContext<HTMLLabelElement, Assign<JsxStyleProps, Select.LabelProps>>(Select.Label, 'label');

export const Positioner = withContext<HTMLDivElement, Assign<JsxStyleProps, Select.PositionerProps>>(
  Select.Positioner,
  'positioner',
);
