...
export const CloseTrigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, Dialog.CloseTriggerProps>>(
  Dialog.CloseTrigger,
  'closeTrigger',
);
...
export const Description = withContext<HTMLParagraphElement, Assign<JsxStyleProps, Dialog.DescriptionProps>>(
  Dialog.Description,
  'description',
);

export const Positioner = withContext<HTMLDivElement, Assign<JsxStyleProps, Dialog.PositionerProps>>(
  Dialog.Positioner,
  'positioner',
);

export const Title = withContext<HTMLHeadingElement, Assign<JsxStyleProps, Dialog.TitleProps>>(Dialog.Title, 'title');
