...
export const Arrow = withContext<HTMLDivElement, Assign<JsxStyleProps, Tooltip.ArrowProps>>(Tooltip.Arrow, 'arrow');
...
export const Positioner = withContext<HTMLDivElement, Assign<JsxStyleProps, Tooltip.PositionerProps>>(
  Tooltip.Positioner,
  'positioner',
);
