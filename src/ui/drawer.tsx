...
export const CloseTrigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, Drawer.CloseTriggerProps>>(
  Drawer.CloseTrigger,
  'closeTrigger',
);
...
export const Description = withContext<HTMLParagraphElement, Assign<JsxStyleProps, Drawer.DescriptionProps>>(
  Drawer.Description,
  'description',
);
...
export const Positioner = withContext<HTMLDivElement, Assign<JsxStyleProps, Drawer.PositionerProps>>(
  Drawer.Positioner,
  'positioner',
);

export const Title = withContext<HTMLHeadingElement, Assign<JsxStyleProps, Drawer.TitleProps>>(Drawer.Title, 'title');
