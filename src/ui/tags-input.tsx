...
export interface RootProps extends Assign<JsxStyleProps, TagsInput.RootProps>, TagsInputVariantProps {}
export const Root = withProvider<HTMLDivElement, RootProps>(TagsInput.Root, 'root');

export const ClearTrigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, TagsInput.ClearTriggerProps>>(
...
export const ItemInput = withContext<HTMLInputElement, Assign<JsxStyleProps, TagsInput.ItemInputProps>>(
  TagsInput.ItemInput,
  'itemInput',
);

export const ItemPreview = withContext<HTMLDivElement, Assign<JsxStyleProps, TagsInput.ItemPreviewProps>>(
  TagsInput.ItemPreview,
  'itemPreview',
);

export const Item = withContext<HTMLDivElement, Assign<JsxStyleProps, TagsInput.ItemProps>>(TagsInput.Item, 'item');

export const ItemText = withContext<HTMLSpanElement, Assign<JsxStyleProps, TagsInput.ItemTextProps>>(
  TagsInput.ItemText,
  'itemText',
);
