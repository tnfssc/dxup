...
export interface RootProps extends Assign<JsxStyleProps, SegmentGroup.RootProps>, SegmentGroupVariantProps {}
export const Root = withProvider<HTMLDivElement, RootProps>(SegmentGroup.Root, 'root');

export const Indicator = withContext<HTMLDivElement, Assign<JsxStyleProps, SegmentGroup.IndicatorProps>>(
  SegmentGroup.Indicator,
  'indicator',
);

export const ItemControl = withContext<HTMLDivElement, Assign<JsxStyleProps, SegmentGroup.ItemControlProps>>(
...
export const ItemText = withContext<HTMLSpanElement, Assign<JsxStyleProps, SegmentGroup.ItemTextProps>>(
