...
export const Content = withContext<HTMLDivElement, Assign<JsxStyleProps, Tabs.ContentProps>>(Tabs.Content, 'content');
...
export const List = withContext<HTMLDivElement, Assign<JsxStyleProps, Tabs.ListProps>>(Tabs.List, 'list');
