...
export interface RootProps extends Assign<JsxStyleProps, Clipboard.RootProps>, ClipboardVariantProps {}
...
export const Indicator = withContext<HTMLDivElement, Assign<JsxStyleProps, Clipboard.IndicatorProps>>(
  Clipboard.Indicator,
  'indicator',
);
...
export const Trigger = withContext<HTMLButtonElement, Assign<JsxStyleProps, Clipboard.TriggerProps>>(
  Clipboard.Trigger,
  'trigger',
);

export { ClipboardContext as Context, type ClipboardContextProps as ContextProps } from '@ark-ui/react/clipboard';
